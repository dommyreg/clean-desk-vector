...
#    print(f"--------- Vector started seeing an object --------- \n{evt.obj}")
    ...
    if (object_type.name) == "CustomType00":
#            print ("sucess!")
            robot.anim.play_animation_trigger('GreetAfterLongTime')
             #robot.behavior.say_text("I see marker!")
...
def main():
    ...
    with anki_vector.Robot('00704c45', enable_custom_object_detection=True, enable_nav_map_feed=True) as robot:
        ...
        #robot.events.unsubscribe(on_object_appeared, anki_vector.events.Events.object_appeared)
        #robot.events.unsubscribe(handle_object_disappeared, anki_vector.events.Events.object_disappeared)
        ...
        #robot.events.unsubscribe(handle_object_appeared, anki_vector.events.Events.object_appeared)
        #robot.events.unsubscribe(handle_object_disappeared, anki_vector.events.Events.object_disappeared)
